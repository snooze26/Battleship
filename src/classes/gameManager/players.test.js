const BattleField = require('../battleFieldClass.js');
...
test("Computer ship has been attacked by player and marked as 'H' " , () => {

    const mockRandom = jest.fn()
    .mockReturnValueOnce(0.1) // x = floor(0.1 * 8) = 8
    .mockReturnValueOnce(0.2) // y = floor(0.2 * 8) = 1 

    const humanPlayer = new Players.HumanPlayer("Tony the tiger"); 
    const computerPlayer = new Players.ComputerPlayer("Tony the bot " , "easy");
    
    humanPlayer.battleField = new BattleField(3, 3); 
    ...
    const resultCell1 = computerPlayer.battleField.getBattleField()[0][1]
